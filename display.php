...
<li class="nav-item">
            <a class="nav-link" href="cart.php"><i class="fa fa-thin fa-cart-shopping"></i><sup>0</sup></a> <!-- Add another fa before to make it visible-->
</li>
<li class="nav-item">
      ...
      <form class="d-flex" role="search"> <!-- dflex places it in a horizontal place same as the search-->
...
<?php
//if statement to display welcome concatinated with the username of the user logged in//
...
// if statement to display login or logout if the user is logged in or logged out respectfully//
if(!isset($_SESSION['username'])){
  echo "<li class='nav-item'>
...
<div class="bg-warning text-center">
    <p>All rights reserved. Designed by Shaun Ndiritu 2023</P>
</div>
    </div>
-->
